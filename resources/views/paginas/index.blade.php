...
<body>
    ...
    <nav class="w3-sidebar w3-collapse w3-animate-left navbar" style="z-index:3;width:300px;" id="mySidebar"><br>
        <div class="w3-container w3-row">
            ...
            <div class="w3-col s8 w3-bar">
                <span>Bem Vindo,<br>{{ Auth::guard('condominos')->user()->nome }} </span><br>
    ...
    <!-- !PAGE CONTENT! -->
    <div class="w3-main w3-collapse" style="margin-left:300px; margin-top:90px;" style="color:white">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-signin w-100 m-auto">
                            <form style="font-color: black;" method="POST" action="/editarUsuario">

                                <div class="form-floating mb-3" style="color: black">
                                    <input style="border: solid rgb(29, 28, 28) 1px; border-radius: 10px; color: black;"
                                        type="text" name="nome" class="form-control  formADD " id="floatingInput"
                                        value="{{ Auth::guard('condominos')->user()->nome }}">
                                ...
                                <div class="form-floating" style="color: black">
                                    <input style="border: solid rgb(29, 28, 28) 1px; border-radius: 10px;"
                                        style="color: black" type="email" name="email" class="form-control formADD"
                                        id="floatingPassword" value="{{ Auth::guard('condominos')->user()->email }}">
